...
pub struct DataPageTasksRewardFullSchema {
    #[serde(rename = "data")]
    pub data: Vec<models::TasksRewardFullSchema>,
...
impl DataPageTasksRewardFullSchema {
    pub fn new(
        data: Vec<models::TasksRewardFullSchema>,
        total: Option<u32>,
        page: Option<u32>,
        size: Option<u32>,
